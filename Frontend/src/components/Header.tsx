...
const Header: React.FC = () => {
    ...
    return (
        <>
            <div
                className="flex items-center justify-between px-8 py-3.5 bg-gray-800 bg-gradient-to-b from-black/80 to-red-950/80 text-red-100 border-b border-red-50/30"
            >
                <a
                    href="/" className="flex font-bold text-2xl font-sans bg-clip-text text-transparent bg-gradient-to-r from-yellow-300 to-red-600 hover:text-white group transform active:scale-90"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        stroke="red"
                        className="h-6 w-6 group-hover:stroke-white"
                ...
                <div className="lg:flex items-center space-x-3.5 hidden">
                    <a
                        className="text-sm text-gray-400 hover:text-gray-100 hover:underline-offset-4 hover:underline hover:bg-gray-600 rounded py-2 px-1 transform active:scale-90"
                ...
                {authData ? (
                    ...
                    <ul className="flex">
                        <li><a
                            className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 transition-colors duration-900 ease-in-out transform active:scale-90 bg-transparent hover:bg-gradient-to-r from-yellow-300 to-red-600 text-sm text-gray-50 hover:text-gray-800 rounded-xl font-bold"
                            href="/inicioSesion">Inicio de Sesión</a></li>
                        <li><a
                            className="hidden lg:inline-block py-2 px-6 font-bold text-sm text-white bg-gradient-to-r from-red-600 to-purple-600 hover:from-blue-600 hover:to-green-500 rounded-xl transition-colors duration-500 transform active:scale-90"
